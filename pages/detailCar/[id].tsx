        ...
        <Layout pageTitle="Detail Car">
            <div className='bg-white mx-auto'>
                ...
                <div className='bg-[#F6F7F9] h-full px-5 py-8 mt-8'>
                    <div className='bg-primary-500 flex flex-col justify-center text-white h-[232px] rounded-md relative'>
                    ...
                    <div className='mt-8 bg-white rounded-md p-4'>
                        ...
                        <p className='text-secondary-300 text-[12px] font-medium mt-4'>NISMO has become the embodiment of Nissans outstanding performance, inspired by the most unforgiving proving ground, the race track.</p>
